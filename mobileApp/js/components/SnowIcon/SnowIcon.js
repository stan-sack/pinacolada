...
class SnowIcon extends React.Component {
	constructor(props) {
		...
		this.state.flakeOneY = this.state.flakeOneTimer.interpolate({
			...
			outputRange: [-4 / 50 * props.size, -0.8 / 50 * props.size, 3 / 50 * props.size, 7 / 50 * props.size, -4 / 50 * props.size]
		})
		...
		this.state.flakeThreeY = this.state.flakeThreeTimer.interpolate({
			inputRange: [0, 1, 2, 4, 5],
			outputRange: [-10 / 50 * props.size, -5 / 50 * props.size, -2 / 50 * props.size, 2 / 50 * props.size, -10 / 50 * props.size]
		})
