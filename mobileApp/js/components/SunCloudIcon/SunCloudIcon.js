			...
			<View style={{ height: this.props.size, width: this.props.size }}>
				...
				<Animated.View
					...
					<Svg viewBox={'0 0 512 512'} height={this.props.size} width={this.props.size}>
						<Path
							fill={this.props.colour}
							d={'M208,64c8.8,0,16-7.2,16-16V16c0-8.8-7.2-16-16-16s-16,7.2-16,16v32C195,56.8,199.2,64,208,64z'} />
					</Svg>
				</Animated.View>
				...
				<Animated.View
					...
					<Svg viewBox={'0 0 512 512'} height={this.props.size} width={this.props.size}>
						<Path
							fill={this.props.colour}
							d={'M352,208c0,8.8,7.2,16,16,16h32c8.8,0,16-7.2,16-16s-7.2-16-16-16h-32C359.2,195,352,199.2,352,208z'} />
					</Svg>
				</Animated.View>
